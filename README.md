...
- Timestamp: `2022-05-18 09:04`
- Build ID: `ed5a9ff7-82a1-40d8-9c7e-77e4cf4282fb`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ed5a9ff7-82a1-40d8-9c7e-77e4cf4282fb.git
$ cd ed5a9ff7-82a1-40d8-9c7e-77e4cf4282fb
```
